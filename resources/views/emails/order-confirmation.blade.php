                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="width: 100%; max-width: 480px; border-collapse: collapse; text-align: {{ app()->getLocale() === 'he' ? 'right' : 'left' }};">
                    <tr>
                        <td>
                            ...
                            <p style="margin: 0 0 20px; font-size: 15px; line-height: 1.6; color: #17140f;">{{ __('mail.order_confirmation_intro') }}</p>
                            ...
                            <p style="margin: 0 0 16px; font-size: 14px; line-height: 1.6; color: #4a453c;">{{ __('mail.invoice_attached') }}</p>
