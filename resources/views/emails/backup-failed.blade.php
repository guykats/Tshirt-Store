                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="width: 100%; max-width: 480px; border-collapse: collapse; text-align: {{ app()->getLocale() === 'he' ? 'right' : 'left' }};">
                    <tr>
                        <td>
                            ...
                            <p style="margin: 0 0 20px; font-size: 15px; line-height: 1.6; color: #17140f;">{{ __('mail.backup_failed_intro') }}</p>
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="width: 100%; margin: 0 0 24px; border-collapse: collapse; border: 1px solid #e4dfd4;">
                                <tr>
                                    <td style="padding: 10px 14px; background-color: #efeadf; color: #4a453c; font-size: 13px; font-weight: bold;">{{ __('mail.backup_failed_reason') }}</td>
                                </tr>
                                <tr>
                                    <td style="padding: 10px 14px; background-color: #f7f4ee; color: #b3352b; font-size: 13px;">{{ $reason }}</td>
                                </tr>
                            </table>
                            ...
                            <table role="presentation" cellpadding="0" cellspacing="0" border="0" style="margin: 0 0 24px; border-collapse: collapse;">
                                <tr>
                                    <td style="border-radius: 3px; background-color: #8c6a3f;">
                                        <a href="{{ $url }}" style="display: inline-block; padding: 12px 32px; font-size: 14px; font-weight: bold; color: #f7f4ee; text-decoration: none; letter-spacing: 0.5px;">{{ __('mail.backup_failed_action') }}</a>
                                    </td>
                                </tr>
                            </table>
