                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="width: 100%; max-width: 480px; border-collapse: collapse; text-align: {{ app()->getLocale() === 'he' ? 'right' : 'left' }};">
                    <tr>
                        <td>
                            ...
                            <p style="margin: 0 0 20px; font-size: 15px; line-height: 1.6; color: #17140f;">{{ __('mail.order_delivered_intro') }}</p>
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="width: 100%; margin: 0 0 24px; border-collapse: collapse; border: 1px solid #e4dfd4;">
                                <tr>
                                    <td style="padding: 10px 14px; background-color: #efeadf; color: #4a453c; font-size: 13px;">{{ __('mail.order_number') }}</td>
                                    <td style="padding: 10px 14px; background-color: #f7f4ee; color: #17140f; font-size: 13px; text-align: {{ app()->getLocale() === 'he' ? 'left' : 'right' }};">{{ $order->order_number }}</td>
                                </tr>
                            </table>
