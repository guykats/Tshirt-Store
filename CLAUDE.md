...
- **`deploy.yml` silently stopped auto-deploying on 2026-08-01 — still broken
  ...
  2026-08-13 (last re-checked ~12:05 UTC, still zero drift vs. the ~11:38 UTC
  ...
  `proposed` (including 7, 9, 15, 16, 18), the same task-348 oscillation
  already documented below, not a new finding — still no
