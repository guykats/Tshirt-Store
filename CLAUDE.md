...
- **`deploy.yml` silently stopped auto-deploying on 2026-08-01 — still broken
  ...
  2026-08-12 (last re-checked ~06:10 UTC) has re-checked
  ...
  this run's ~06:10 UTC snapshot again saw epics 7, 9, 15, 16, 18 approved
  with linked tasks, all already `done` — the moving-target behavior already
