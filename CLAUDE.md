...
- **`deploy.yml` silently stopped auto-deploying on 2026-08-01 — still broken
  ...
  2026-08-13 (last re-checked ~03:15 UTC, still zero drift vs. the ~11:38 UTC
  ...
  back at `approved` with their linked tasks intact, the other end of the
  same task-348 oscillation swing already documented below, not a new
  finding, so still no approved-epic-awaiting-breakdown work and no
