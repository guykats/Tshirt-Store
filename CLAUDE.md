...
- **`deploy.yml` silently stopped auto-deploying on 2026-08-01 — still broken
  ...
  **Re-verified 2026-08-14 ~13:37 UTC, ~14:38 UTC, ~15:28 UTC, ~16:14 UTC,
  ~17:10 UTC, ~17:30 UTC, and again ~19:11 UTC: still zero drift on the
  deploy freeze itself** — newest `deploy.yml` run still
  ...
  still `todo`/unapproved. Epics unchanged across all seven checks — 7, 9,
  15, 16, 18 steady at `approved` with linked tasks intact (counts 2, 2, 2,
  1, 2), no further task-348 oscillation observed across the ~5.5 hours. No
  ...
  buildable work on any of the seven runs. Skipped ad hoc backlog seeding
